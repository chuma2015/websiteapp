                 ...
                 <div class="table-responsive">
					...
					<div class="col-sm-12 col-md-12 well">
					  <table class="table table-hover">
						<tr><th><small>Title</small></th><th><small>Date Posted</small></th>
						<?php echo "<th><small>Action</small></th>"; ?></tr>
						<?php 
						 $news = publication::find_by_type(1); 
						foreach($news as $new){ 
						echo "<tr class='record'>
						<td><small>".substr($new->title, 0, 100)."</small></td>
						<td><small>".$new->date_post."</small></td>";
						echo "
						<td><a href='#' class='editbutton' title='Edit' id='ej".$new->id."' data-toggle='modal' data-target='#editRow'>
							  <span class='glyphicon glyphicon-edit'></span></a></td>
						<td><small><a href='#' class='delbutton' title='Delete' id='dj".$new->id."'>
