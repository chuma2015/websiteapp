							  ...
							  <div class='box box-warning box-solid collapsed-box'>
								<div class='box-header with-border'>
								  ...
								  <div class='box-tools pull-right'>
									<button type='button' class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-plus'>More info</i>
									</button>
								  </div>
								  <!-- /.box-tools -->
								</div>
								...
								<div style='display: none;' class='box-body'>
								  <p><b>Registration Number</b>:$new->regno</p>
								   <p><b>Name</b>:$new->name</p>
								    <p><b>Type</b>:$new->stype</p>
									 <p><b>Registration Date</b>:$new->rdate</p>
									 <p><b>Formation Date</b>:$new->fdate</p>
									 <p><b>Status</b>:$new->status</p>
									 <p><b>Location</b>:$new->location</p>
									 <p><b>Shares</b>:$new->share</p>
									 <p><b>Activities</b>:$new->activities</p>
								</div>
								<!-- /.box-body -->
							  </div>
							  <!-- /.box -->
