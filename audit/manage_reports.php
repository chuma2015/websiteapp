  ...
  <div class="content-wrapper">
	...
	<div class="box">
            <div class="box-header">
              <h3 class="box-title">All published Reports</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                 ...
                 <div class="table-responsive">
					...
					<div class="col-sm-12 col-md-12 well">
					  <table class="table table-hover">
						...
						<?php 
						 $news = publication::find_by_type(3); 
						foreach($news as $new){ 
						echo "<tr class='record'>
						<td><small>".substr($new->title, 0, 100)."</small></td>
						<td><small>".$new->date_post."</small></td>";
						echo "
						<td><a href='#' class='editbutton' title='Edit' id='rt".$new->id."' data-toggle='modal' data-target='#editRow'>
							  <span class='glyphicon glyphicon-edit'></span></a></td>
						<td><small><a href='#' class='delbutton' title='Delete' id='rf".$new->id."'>
