            ...
            <form class="form-horizontal" name="post_news" method="POST" action="" enctype="multipart/form-data">
			  ...
			  <div class="col-sm-10">
                  <select class="form-control" name="userType" required>
                    ...
                    <option value="3">Reginal Officer</option>
                  </select>
				  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input class="form-control" placeholder="Enter ..." type="text" name="fname" required>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input class="form-control" placeholder="Enter ..." type="text" name="lname" required>
                  </div>
                </div>
				<div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Userame</label>

                  <div class="col-sm-10">
                   <input class="form-control" placeholder="Enter ..." type="text" name="uname" required>
                  </div>
                </div>
...
<?php 
								if(isset($_POST['save'])){
								$add = new User();
								$add->first_name = trim($_POST['fname']);
								$add->surname = trim($_POST['lname']);
								$add->username = trim($_POST['uname']);
								$add->level = trim($_POST['userType']);
								$add->password = sha1("123456");
								...
								//save info to system activities
											...
											$act->act_name = "Register user with this username: ".$_POST['uname']."";
