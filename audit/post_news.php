            ...
            <form class="form-horizontal" name="post_news" method="POST" action="" enctype="multipart/form-data">
			  ...
			  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="details" required></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Attach File</label>
				  <div class="col-sm-10">
                  <div class="input-group">
						...
						<hr class="dashed" />
                  <p class="help-block">Attach the file for news-optional.</p>
				  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <input type="submit" class="btn btn-info pull-right" value="Post" name="post_news">
              </div>
              <!-- /.box-footer -->
            </form>
		<?php 
								...
								$add->details = trim($_POST['details']);
								$add->attach_file($f);
								...
								//save info to system activities
											...
											$act->id = $session->uid;
											$act->act_name = "Add new News: ".$_POST['title']."";
