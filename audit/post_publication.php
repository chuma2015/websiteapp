  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" name="post_publication" method="POST" action="" enctype="multipart/form-data">
              <div class="box-body">
			  ...
			  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input class="form-control" placeholder="Enter ..." type="text" name="title" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Document input</label>
				  <div class="col-sm-10">
                  <input id="exampleInputFile" type="file" name="pic_name" required>

                  <p class="help-block">Document ca be PDF or DOC type.</p>
				  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <input type="submit" class="btn btn-info pull-right" value="Post" name="post_publication">
              </div>
              <!-- /.box-footer -->
            </form>
			<?php 
								...
								$add->description = trim($_POST['description']);
								$add->attach_file($f);
								$add->user_post =  $_SESSION['uname'];
								$add->date_post = strtotime('now');
								$add->date_post = strftime("%B %d, %Y at %I:%M %p", $add->date_post);
								$add->save();
								...
								//save info to system activities
											...
											$act->act_name = "Add new Publication: ".$_POST['title']."";
