  ...
  <div class="content-wrapper">
	...
	<div class="box">
            <div class="box-header">
              <h3 class="box-title">All posted News and Events</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			  ...
			  <div class="col-sm-12">
			   <?php	//to be converted to OOP
                ...
                <thead>
                <tr role="row">
				<th aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending" style="width:12px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting_asc">
				#
				</th>
				<th aria-label="Platform(s): activate to sort column ascending" style="width: 197px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">
				Title
				</th>
				<th aria-label="Engine version: activate to sort column ascending" style="width: 155px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">
				Date Posted
				</th>
				<th aria-label="CSS grade: activate to sort column ascending" style="width: 110px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">
				Action
				</th>
				</tr>
                </thead>
                ...
                <?php
				$i=0;
				$news = resource::find_all(); 
				foreach($news as $new){ 
				$i++;
                    echo "
				  <tr class='odd record' role='row'>
                  <td class='sorting_1'>$i</td>
                  <td>".$new->title."</td>
                  <td>".$new->date_post."</td>
                  <td><a href='#' class='editbutton' title='Edit' id='re".$new->id."' data-toggle='modal' data-target='#editRow'>
					  <span class='glyphicon glyphicon-edit'></span></a></a>
				  &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp
				  <a href='#' class='delbutton' title='Delete' id='rd".$new->id."'>
