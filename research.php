...
<span aria-label="breadcrumb separator">/</span> Research Papers</div><div class="post-35 page type-page status-publish hentry entry">
...
<?php	//to be converted to OOP
                 ...
                 <div class="table-responsive">
					...
					<div class="span10">
								  <?php
						    $publications = publication::find_by_type(2); 
