...
<div class="breadcrumb" itemprop="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList"><a href="index.php"><span>Home</span></a>
 <span aria-label="breadcrumb separator">/</span> Journals</div><div class="post-35 page type-page status-publish hentry entry"><h1 class="entry-title">Journals</h1> 
...
<?php	//to be converted to OOP
                 ...
                 <div class="table-responsive">
					...
					<div class="span10">
								  <?php
						    $publications = publication::find_by_type(1); 
						...
						<div class='span4 well'>
							...
							<div id='pbdetails'>
								<blockquote><a href='admin/publications/".$new->file_name."'>".$new->description."</a></blockquote>
							</div>
							<div id='pbauthor'>
							<p><b>Date:".$new->date_post."|<a href='admin/publications/".$new->file_name."'>Download</a></b></p>
							</div>
							</div>
						</div>
...
<script type="text/javascript" src="admin/dist/js/pacsal_subEngine.js"></script>